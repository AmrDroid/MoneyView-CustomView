...
class MoneyKeyboardView : View {
    ...
    var deleteRes = R.drawable.ic_delete

    @SuppressLint("ResourceType")
    var confirmRes = R.drawable.ic_confirm
    ...
    constructor(context: Context?, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr, 0){
        ...
        var typedArray = context.obtainStyledAttributes(attrs, R.styleable.MoneyKeyboardView)
        textSize = typedArray.getDimensionPixelOffset(R.styleable.MoneyKeyboardView_textSize, 28)
        textColor = typedArray.getColor(
            R.styleable.MoneyKeyboardView_textColor,
            Color.parseColor("#000000")
        )
        dividerColor = typedArray.getColor(
            R.styleable.MoneyKeyboardView_dividerColor,
            Color.parseColor("#BFBFBF")
        )
        keyBackground = typedArray.getDrawable(
            R.styleable.MoneyKeyboardView_keyBackground
        )
        ...
        deleteRes = typedArray.getResourceId(
            R.styleable.MoneyKeyboardView_deleteDrawable,
            R.drawable.ic_delete
        )
        confirmRes = typedArray.getResourceId(
            R.styleable.MoneyKeyboardView_confirmDrawable,
            R.drawable.ic_confirm
        )
        typedArray.recycle()
